...
const RoomDetails = () => {
  ...
  return room &&(
    <div className='py-28 md:py-35 px-4 md:px-16 l`g:px-34 xl:px-32'>
        ...
        <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            ...
            <button type='submit' className='bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounde-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>
                Check Availablity
            </button>
        </form>
        ...
        <div className='mt-25 space-y-4'>
            {roomCommonData.map((spec,index)=>(
                <div key={index} className='flex items-start gap-2'>
                    ...
                    <div>
                        <p className='text-base'>{spec.tilte}</p>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>Gueste will be allocate on the ground floor according to availablity.You get a comfortable Two bedroom apartment has a true city feeling.The price quoted is for two guest, at the guest slot please the number of guests to get the exact price for groups.</p>
        </div>
        ...
        <div className='flex flex-col items-start gap-4'>
            <div className='flex gap-4'>
                ...
                <div>
                    <p className='text-lg md:text-xl'>Hosted by {room.hotel.name3}</p>
