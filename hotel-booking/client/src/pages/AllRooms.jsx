...
const CheckBox=({label,selected=false, onChange=()=>{}})=>{
    return(
       <label className="flex gap-3 intem-center cursor-pointer mt-2 text-sm">
        ...
        <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>
                    Take a advantage of our limited offers and special package to enchance  your stay and create unforgettable memories.
                </p>
            </div>
            ...
            {roomsDummyData.map((room)=>(
                <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last-border-0'>
                    ...
                    <div className='md:w-1/2 flex flex-col gap-2'>
                        ...
                        <p className='text-xl font medium txt gray-700'>${room.pricePerNight}/night</p>
                    </div>
